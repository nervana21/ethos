...
use crate::feature_aware_cargo;
use crate::feature_aware_mod;
use crate::generation_context::{GenerationContext, UsedExternalSymbols};
use crate::module_generators::ModuleGenerator;
use crate::module_generators::{
	client_trait::ClientTraitModuleGenerator, lib_rs::LibRsModuleGenerator,
	node_manager::NodeManagerModuleGenerator, response_types::ResponseTypesModuleGenerator,
	test_node::TestNodeModuleGenerator, transport::TransportModuleGenerator,
};
...
pub fn analyze_implementation(
	implementation: Implementation, protocol_ir: ProtocolIR, version: &ProtocolVersion,
