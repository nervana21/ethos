...
mod tests {
    ...
    // Intentionally avoid deriving Serialize/Deserialize in the core crate
    // to keep dependencies minimal as per design; serialization round-trips
    // are exercised by backends and integration tests using serde_json::Value.
}
