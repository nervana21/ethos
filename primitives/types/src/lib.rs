...
impl MethodResult {
	...
	pub fn new(
		type_: String, optional: bool, description: String, key_name: String, condition: String,
...
impl ApiDefinition {
	...
	pub fn with_implementation_and_version(
		implementation: Implementation, version: ProtocolVersion,
	...
	pub fn get_method(&self, name: &str) -> Option<&serde_json::Value> {
...
impl TypeRegistry {
	...
	pub fn map_result_type(
		result: &MethodResult, adapter: &dyn type_adapter::TypeAdapter,
	) -> (String, bool) {
	...
	pub fn map_argument_type_with_adapter(
		arg: &Argument, adapter: &dyn type_adapter::TypeAdapter,
	) -> (String, bool) {
