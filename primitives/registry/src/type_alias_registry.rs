...
//! Type Alias Registry — semantic database for type canonicalization mappings.
//!
...
impl TypeAliasRegistry {
	...
	pub fn new(alias_to_canonical: HashMap<String, String>) -> Self {
...
impl TypeAliasRegistryReader for TypeAliasRegistry {
	...
	fn is_canonical_type(&self, type_name: &str) -> bool {
		self.is_canonical_type(type_name)
	}
}
