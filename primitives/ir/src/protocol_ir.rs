...
impl ProtocolIR {
	...
	pub fn modules(&self) -> &[ProtocolModule] {
		&self.modules
	}

	/// Get mutable reference to all modules in this protocol
	pub fn modules_mut(&mut self) -> &mut Vec<ProtocolModule> {
		&mut self.modules
	}
	...
	pub fn description(&self) -> &'static str {
		"The canonical Ethos protocol specification"
	}
...
impl ProtocolModule {
	...
	pub fn definitions(&self) -> &[ProtocolDef] {
		&self.definitions
	}

	/// Get mutable reference to all definitions in this module
	pub fn definitions_mut(&mut self) -> &mut Vec<ProtocolDef> {
		&mut self.definitions
	}

	/// Create a new protocol module
	pub fn from_source(
		name: &str, desc: &str, defs: Vec<ProtocolDef>, _source: &'static str,
	) -> Self {
...
impl RpcDef {
	...
	pub fn result_type_name(&self) -> Option<&str> {
