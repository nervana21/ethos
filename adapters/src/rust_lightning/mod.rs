...
use crate::normalization_registry::NormalizationRegistry;
...
impl RustLightningAdapter {
	...
	async fn make_http_rpc_call(
		&self, client: &reqwest::Client, method: &str, params: Value,
	) -> Result<Value, RustLightningError> {
...
impl crate::rpc_adapter::BackendProvider for RustLightningAdapter {
	fn implementation() -> types::Implementation {
		types::Implementation::RustLightning
	}
